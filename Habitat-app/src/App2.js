  ...
  const renderMobileMenu = (
    <Menu 
      ...
      <MenuItem style={{marginLeft: "-1%", width:340, height:50 }}>
          ...
          <li>
              <i></i>
              <span onClick={Logout} class="links_name">Log Out </span>
          </li>            
      </MenuItem>
    </Menu>
  );
  const [islogin, setIslogin] = useState(false);
    ...
    {islogin? 
      ...
      <Router>        
          ...
          <Navbar2 isOpened={word => setWord(word)}></Navbar2>  
            <div className='main' style={{ backgroundColor: "#F3F7FC", position: 'relative' }}>
                  <Route path="/bill/:id" exact={true} render={(props) => <Billpage isOpened={word} {...props} />} />
                  <Route path="/announce/:id" exact={true} render={(props) => <Announcep isOpened={word} {...props} />}/>
                  <Route path="/expense/:id" exact={true} render={(props) => <Expensepage isOpened={word} {...props} />} />
