      ...
      return (
        <Toolbar>
            ...
            {numSelected} Selected All
                ...
                <Typography className={classes.Move} id="tableTitle" component="div">
                  Select All
                </Typography>
           )} 
            {numSelected > 0 ? (
            ...
            <div className={isOpened ? classes.scrollspace36 : classes.scrollspace}>
              <div>
                <div className={classes.frame}>
                  <Datetoday/>                        
                  <h5 className={classes.headBuilding} id="newannouncetitle">  Petitions </h5>   

      <div className="row align-items-start">                
          <div className="col align-self-start">
              <Paper component="form" className={classes.Searchstyle}>
                  <BootstrapInput type="text" size="small" variant="outlined"    
                      placeholder="search"
                          onChange={(e)=>{
                         ...
                         <TableRow role="checkbox" aria-checked={isItemSelected} tabIndex={-1} key={index.id} selected={isItemSelected}>   
                            <TableCell>
                                <Checkbox size="small" color="primary"
                                    ...
                                    />
                                    <Link to={`/notedetails/${info.id}`} style={{ textDecoration: 'none' }}>
