...
export default function CreateFeeset(props) {
  ...
  console.log(selected)
            ...
            <div className="container ">
              <div style={{ display: "flex" }} className={classes.setwidth2}>
                    <div style={{ width: "45%" }} >
                        ...
                        <input className={classes.setrow}
                                placeholder="Name"
                                type="text"
    ...
    <h5 className={classes.head}> Select Fee Types <Button onClick={handleClickOpen}></Button>  
              ...
              <DialogContent>
                <DialogContentText>
                    <div className="Building">
                            ...
                            <Table>
                                <TableBody>      
                                    {feetype.map((row,index) => {
                                      ...
                                      return(      
                                          <TableRow role="checkbox" aria-checked={isItemSelected} tabIndex={-1} key={index.id} selected={isItemSelected}>       
                                            <TableCell> 
                                                <Checkbox 
                                                    color="primary" checked={isItemSelected} onClick={(event) => handleClick(event, row.id)}
                          ...
                          <DialogActions>
                              <Button variant="contained" color="primary" disableElevation style={{ backgroundColor: '#485D84' }}>Create</Button>   
                              <Button variant="contained"  disableElevation onClick={handleClickOpen}> cancel </Button>    
                          </DialogActions>
                  </DialogContentText>
              </DialogContent>      
          </Dialog>
                          ...
                          const labelId = `enhanced-table-checkbox-${index}`;
                            return(      
                                    <TableRow 
                                        ...
                                        <TableCell align="Left"><h5>{row.feeTypeName}</h5></TableCell>
                                        <TableCell>
